      ...
      <div className="flex flex-col rounded-none bg-card shadow-2xl sm:rounded-xl font-sans
        ...
        <div className="flex-1 space-y-3 overflow-y-auto px-4 text-card-foreground">
          <div className="space-y-2">
            ...
            {images.length > 0 && (
              <div className="space-y-2">
                <div className="relative overflow-hidden rounded-lg h-124">
                  <Image src={images[photoIndex]} alt={place.name ?? "Place image"} fill className="object-cover" />
                  {images.length > 1 && (
          ...
          <div className="space-y-3 pb-2 leading-relaxed">
            ...
            {place.tel && (
              <div className="space-y-1 text-sm">
                ...
                <p className="text-card-foreground">{place.tel}</p>
              </div>
            )}
